...
export class AnalyticsController {
   ...
   *         description: Internal server error
   */
  async getIssuesByStatus(req: Request, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
   ...
   *         description: Internal server error
   */
  async getIssuesByRepo(req: Request, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
   ...
   *         description: Internal server error
   */
  async getIssuesOverTime(req: Request, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
      ...
      const data = await analyticsService.getIssuesOverTime(
        userId,
   ...
   *         description: Internal server error
   */
  async getAssigneeWorkload(req: Request, res: Response): Promise<void> {
    try {
      const userId = req.user!.id;
